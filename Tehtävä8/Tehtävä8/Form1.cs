...
namespace Tehtävä8
{
    public partial class RoomalaisiksiForm : Form
    {
        ...
        private void muutaBT_Click(object sender, EventArgs e)
        {
            ...
            else if (tekstiTB.Text.Length >2) // Kysessä on sataluku
            {
            ...
            else if (tekstiTB.Text.Length > 1) // Kysessä on kymmenluku
            {
            ...
            else if (tekstiTB.Text.Length > 0) // Kysessä on ykkösluku
            {
