    ...
    public partial class YllapitoForm : Form
    {
        ...
        private void TallennaBT_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Utta opiskelija ei pystytty lisäämään", "Opiskelijan lisäys", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            TietotauluDG.DataSource = opiskelija.haeOpiskelijat();
        }
        ...
        private void PoistaBT_Click(object sender, EventArgs e)
        {
            ...
            {
                TietotauluDG.DataSource = opiskelija.haeOpiskelijat();
                MessageBox.Show("Opiskelija postettu onnistuneesti", "OPiskelija poisto", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
